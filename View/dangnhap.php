...
<section class="login-block">
    ...
    <form  action="index.php?action=admin&act=dangnhap_action" class="login-form" method="post">   
    ...
    <p>Bạn Không Có Tài Khoản?<a href="index.php?action=dangky">Đăng Ký</a></p>
    <p>Quên Mật Khẩu?<a href="Index.php?action=forgetpsadmin">Forget PassWord</a></p>
    </div>
</section>
</div>